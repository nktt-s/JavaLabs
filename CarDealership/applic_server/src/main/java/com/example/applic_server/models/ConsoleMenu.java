        ...
        while (menu){
            ...
            switch(input){
                case 1:
                    ...
                    break;
                case 2:
                   all_applics.forEach((applic) -> {if (Objects.equals(applic.get_status(), "On Wait")) applic.print();});
                    break;
                case 3:
                    all_applics.forEach((applic) -> {if (Objects.equals(applic.get_status(), "In Progress")) applic.print();});
                    break;
                case 4:
